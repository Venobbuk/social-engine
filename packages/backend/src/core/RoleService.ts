...
export type RolePolicies = {
	...
	canCreateCompetition: boolean; // COMP-FIXES-A: Reclub canCreateCompetition (a moderator can restrict an account)
...
export const DEFAULT_POLICIES: RolePolicies = {
	...
	canCreateCompetition: true, // COMP-FIXES-A: anyone may create by default
	driveCapacityMb: 100,
	maxFileSizeMb: 30,
...
export class RoleService implements OnApplicationShutdown, OnModuleInit {
	...
	public async getUserPolicies(userId: MiUser['id'] | null): Promise<RolePolicies> {
		...
		return {
			...
			canCreateCompetition: calc('canCreateCompetition', vs => vs.some(v => v === true)), // COMP-FIXES-A
