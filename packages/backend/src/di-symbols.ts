...
export const DI = {
	...
	meetsRepository: Symbol('meetsRepository'),
	meetParticipantsRepository: Symbol('meetParticipantsRepository'),
	meetPlayerLevelsRepository: Symbol('meetPlayerLevelsRepository'),
