...
// CLUB-INVITE-V1: an admin invites one player (club:already_member / club:blocked / club:no_such_user → CLUB_ERROR).
export const meta = {
	tags: ['clubs'],
	...
	constructor(private clubService: ClubService) {
		super(meta, paramDef, async (ps, me) => {
			try {
				...
				return await this.clubService.invite(c, me, ps.userId);
			} catch (e) {
				return toApiError(e);
			}
		});
