...
export const paramDef = {
	type: 'object',
	properties: { channelId: { type: 'string', format: 'misskey:id' }, limit: { type: 'integer', minimum: 1, maximum: 200, default: 100 }, offset: { type: 'integer', minimum: 0, default: 0 }, query: { type: 'string', nullable: true, maxLength: 64 } },
	required: ['channelId'],
} as const;
...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(private clubService: ClubService) {
		super(meta, paramDef, async (ps, me) => {
			...
			return await this.clubService.members(c, me, { limit: ps.limit, offset: ps.offset, query: ps.query ?? undefined });
			} catch (e) {
				return toApiError(e);
			}
		});
