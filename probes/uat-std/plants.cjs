...
<div id="app" class="taro_router"><div class="taro_page taro_page_show"><div class="sh sh-app"><div class="sh-app-body"><div class="sh-page">
  <div class="hdr">
    ${p.plantHeaderLeft ? '<button type="button" class="av" aria-label="Profile" style="border-radius:22px"><img alt="" width="28" height="28" src="data:image/gif;base64,R0lGODlhAQABAAAAACw="></button>' : '<button type="button" aria-label="' + (zh ? '返回' : 'Back') + '">&lsaquo;' + (p.srOnly ? '<span class="sr-only" style="position:absolute;width:1px;height:1px;overflow:hidden;white-space:nowrap">' + (zh ? '返回上一頁' : 'Back to the previous page') + '</span>' : '') + '</button>'}
  ...
  ${p.clampRows ? '<div style="display:flex;align-items:center;width:240px;margin:8px 16px"><div style="display:flex;flex-direction:column;flex:1;min-width:0"><span class="row-name" title="Kowloon Dinkers Pickleball Association Friday Night Doubles Ladder" style="display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;font-size:15px;line-height:1.3">Kowloon Dinkers Pickleball Association Friday Night Doubles Ladder</span><span style="font-size:12px">Kowloon Bowling Green Club</span></div><span style="margin-left:8px">6/8</span></div><div style="display:flex;width:240px;margin:8px 16px"><span style="flex:1;min-width:0;overflow:hidden;white-space:nowrap;text-overflow:ellipsis">Next activity · Sun 07:00 pm · Early Birds morning ladder</span><span style="margin-left:8px">Tue 08:00</span></div><div class="si-name" style="width:320px;margin:8px 16px;font-size:28px;line-height:0.95;font-weight:900">Hong Kong <span style="display:block">Pickleball League</span></div>' : ''}
  ${p.toast ? '<div class="taro__toast"><div style="position:fixed;z-index:1000;top:0;right:0;left:0;bottom:0;display:none"></div><div style="z-index:5000;box-sizing:border-box;display:flex;flex-direction:column;justify-content:center;position:fixed;top:50%;left:50%;min-width:120px;max-width:200px;min-height:120px;padding:15px;transform:translate(-50%,-50%);border-radius:5px;text-align:center;color:#fff;background:rgba(17,17,17,.7)"><p>Matches generated</p></div></div>' + (p.plantToastCatches ? '' : '<style>.taro__toast { pointer-events: none; } .taro__toast > div:first-child { pointer-events: auto; }</style>') : ''}
  ${p.switchRow ? '<div style="display:flex;flex-direction:column;margin:8px 16px"><span>Players may score</span><div role="switch" aria-checked="true" aria-label="Players may score" tabindex="0" style="height:28px;border-radius:14px;background:#0b192c;' + (p.plantSwitchWide ? '' : 'width:46px;align-self:flex-start;') + '"></div></div>' : ''}
  ${p.plantClampNoTitle ? '<span class="club-name" style="display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;width:90px;margin:8px 16px">Kowloon Dinkers Pickleball Association Seniors</span>' : ''}
  ${p.plantClamp3 ? '<span class="club-name" title="Kowloon Dinkers Pickleball Association Seniors Ladder Night" style="display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:3;overflow:hidden;width:90px;margin:8px 16px">Kowloon Dinkers Pickleball Association Seniors Ladder Night</span>' : ''}
